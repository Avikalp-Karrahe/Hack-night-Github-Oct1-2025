# Claude Desktop Prompts for Building project leverages modern technologies and frameworks to deliver robust, scalable, and maintainable solution
...
- **GitHub URL:** https://github.com/octocat/Spoon-Knife
- **Primary Language:** html
- **Project Type:** Web Frontend
- **File Count:** 0
- **Live Demo:** Not available
- **Complexity:** Simple
- **Reference Documentation:** octocat_Spoon-Knife_documentation.md
...
```
You are a senior full-stack developer and Vite specialist. I need you to help me build project leverages modern technologies and frameworks to deliver robust, scalable, and maintainable solution, project leverages modern technologies and frameworks to deliver a robust, scalable, and maintainable solution.

**Project Context:**
- Primary Language: html
- Framework: Vite
- Reference Repository: https://github.com/octocat/Spoon-Knife
...
**Technology Stack:**
Primary: html, Frameworks: vite

**Your Role:**
- Expert html/Vite developer with 10+ years experience
...
```
You are an expert Vite developer and e-commerce application architect. Building on the project setup from the previous step, I need you to implement the core functionality.

**Previous Setup Context:**
[PASTE THE OUTPUT FROM PROMPT 1 HERE]

**Project Details:**
- Repository Reference: https://github.com/octocat/Spoon-Knife
- Technology Stack: html + vite
...
- **Modern Architecture**: Built with Vite best practices
...
*Generated by Enhanced PromptSwitch for project leverages modern technologies and frameworks to deliver robust, scalable, and maintainable solution - 2025-10-01 19:34:53*

...
These prompts will help you **build and implement** the **mui_material-u** project from scratch using Claude Desktop, based on the analyzed documentation.
...
*Generated by PromptSwitch v2 for building a REST API application - 2025-06-02 02:37:38*

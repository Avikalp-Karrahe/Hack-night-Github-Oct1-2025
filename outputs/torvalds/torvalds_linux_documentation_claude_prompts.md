# Claude Desktop Prompts for Building torvalds_linux

These prompts will help you **build and implement** the **torvalds_linux** project from scratch using Claude Desktop, based on the analyzed documentation.
...
- **File Count:** 0
- **Reference Documentation:** torvalds_linux_documentation.md
...
This project leverages modern technologies and frameworks to deliver a robust, s...
```
...
```
You are a senior full-stack developer and software architect. I need you to help me build an operating system kernel using Unknown.

**Project Context:**
- Primary Language: Unknown
- Project Type: Unknown
- Reference Repository: https://github.com/torvalds/linux
- Target Complexity: Based on 0 files
- Key Features to Build: Process management, Memory management, File system, Device drivers, System calls
...
**Task:**
Help me plan and set up the foundational architecture for an operating system kernel:
...
**Project Details:**
- Repository Reference: https://github.com/torvalds/linux
- Technology Stack: Unknown, Unknown
- Target: Build an operating system kernel
- Core Features: Process management, Memory management, File system, Device drivers, System calls
...
1. **Core Application Logic**
   - Implement main application entry points for an operating system kernel
   - Create core business logic modules
   - Set up routing and navigation (if applicable)
   - Implement data models and schemas

2. **Feature Implementation**
   - Build these specific features: Process management, Memory management, File system, Device drivers, System calls
...
Please provide complete, working code implementations that I can use to build an operating system kernel with these key features: Process management, Memory management, File system, Device drivers, System calls.
```
...
- Current State: Functional an operating system kernel with core features
- Target: Production-ready deployment
- Features Implemented: Process management, Memory management, File system, Device drivers, System calls
...
Please provide a complete production deployment solution that makes my an operating system kernel ready for real-world use, following industry best practices for reliability, security, and performance.
```
...
- **Functional Application**: Complete, working an operating system kernel built with Unknown
...
- **Key Features**: Process management, Memory management, File system, Device drivers, System calls
...
*Generated by GitRead v2 for building an operating system kernel - 2025-06-02 01:26:39*
